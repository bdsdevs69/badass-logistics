...
<ul>
  ...
  <li><strong>The trailer and equipment assumptions</strong> behind the number — flatbed and RGN for heavy iron, enclosed air-ride for anything precision, and how many loads that implies.</li>
</ul>
...
`,
  ...
  },
  {
    ...
    desc: "How to move a milling machine: knee mill vs. bed mill vs. VMC geometry, builder-documented lift points, what to drain and lock, way protection, skating, and re-level and tram at the destination.",
    ...
    tldr: "How you move a milling machine depends on which kind it is. A Bridgeport-style knee mill (2,000–2,500 lbs) is top-heavy and rigs from the ram; a bed mill or VMC is heavier, lower, and rigs from the base or factory eyebolts. Either way: pull the lift points from the builder's manual, lock the knee, quill, spindle, and axes, protect the ways, skate it low and centered, and re-level and tram at the destination before cutting.",
