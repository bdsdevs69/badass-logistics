...
module.exports = {
  ...
  title: 'Machinery Moving Company | Machinery & Heavy Equipment Movers | Badass Logistics',
  description: 'Machinery movers and heavy equipment moving for single machines, production lines, and plant moves. Survey, rigging, staging, freight, and reinstall.',
  ...
  h1: 'Machinery Movers &amp; <span class="y">Heavy Equipment Moving</span>',
  ...
  intro: {
    ...
    paragraphs: [
      ...
      'We move single machines between bays, relocate complete lines between plants, and take on full facility moves across state lines. When a machine leaves the building, it runs as <a href="/services/project-freight">project freight</a> inside the same plan: <a href="/services/crating-packing">crated or prepped</a> on site, loaded in sequence, and moved through our licensed broker and carrier partners — with <a href="/services/dedicated-lanes">dedicated capacity</a> when there are enough loads to justify it.',
  ...
  process: {
    ...
    steps: [
      ...
      { h: 'Move or stage', p: 'Project freight to the new site through our broker and carrier partners, or into secure staging until your floor is ready.' },
  ...
  faq: [
    ...
    { q: 'Can you move machinery to another state?', a: 'Yes. We rig it out, prep or crate it, manage the transport as <a href="/services/project-freight">project freight</a> through our licensed broker and carrier partners, and set it at the new facility.' },
  ...
  guides: [
    ['how-much-do-machinery-movers-cost', 'How Much Do Machinery Movers Cost?'],
